...
const UUID = process.env.UUID || 'fdf7b399-782c-4b6a-84c3-5e813cbec860'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'nndrty456vg.rootjfennewdonmain.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNWVmN2IzYzc2YmExMWFjOWY3MzYwYTcxYmEzZTgwMzIiLCJ0IjoiMmI1NmUxYzktYmViMC00NWM3LWE0ZTUtMmQ4MDIwOGYyYTUxIiwicyI6Ik1qWTBZV0l6TWpjdE56QTFOUzAwWkRRekxUbGpOakF0WlRJMk1HSTFNR0l3TjJFMiJ9';

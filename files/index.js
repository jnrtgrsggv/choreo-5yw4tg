...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'mfutnjdrxdj.rootjfennewdonmain.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNWVmN2IzYzc2YmExMWFjOWY3MzYwYTcxYmEzZTgwMzIiLCJ0IjoiYWQ2YjBlNDEtMmMzNC00OGFhLThiNmEtYmI2MzEwNTZlYzEzIiwicyI6IlpXUXpaR1pqWVRrdFl6aGpNaTAwTXpOa0xUazBaamt0T0RCaVpqY3paakZtWm1aaSJ9';
